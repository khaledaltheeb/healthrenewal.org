...
class MentalHealthWave4Test(unittest.TestCase):
    ...
    def test_phq9_has_nine_items_and_complete_only_scoring(self):
        names = ['phq1','phq2i','phq3','phq4','phq5','phq6','phq7','phq8','phq9']
        for name in names:
    ...
    def test_phq9_safety_is_independent_from_total(self):
        ...
        self.assertIn('مجموع PHQ‑9 وحده لا يحدد مستوى خطر الانتحار', self.phq)
        self.assertNotIn('خطر منخفض لأن المجموع', self.phq)

    def test_gad7_has_seven_items_and_complete_only_scoring(self):
        names = ['gad1','gad2i','gad3','gad4','gad5','gad6','gad7']
        for name in names:
    ...
    def test_registry_marks_both_public_domain_and_translation_separate(self):
        ...
        for measure in self.registry['measures']:
            ...
            self.assertEqual(rights['status'], 'public-domain')
    ...
    def test_hub_links_both_tools(self):
