...
class TestSiteUpgradePlanV411(unittest.TestCase):
    def test_clinical_safety_blocks_publication(self):
        report = {
            "version": 410,
            "upgrade_queue": [{
                "path": "care-guides/cancer/index.html",
                "route": "care-guides/cancer/",
                "title": "سرطان الأطفال",
                "h1": "سرطان الأطفال",
                "score": 40,
                "priority": 90,
    ...
    def test_research_candidates_unlock_verification_gate(self):
        report = {
            "version": 410,
            "upgrade_queue": [{
                "path": "psychology/example/index.html",
                "route": "psychology/example/",
                "title": "مثال",
                "h1": "مثال",
                "score": 70,
                "priority": 30,
                "risk": "standard",
                "findings": ["thin_content", "no_authoritative_source"],
            }],
            "research_dossiers": [{
                "path": "psychology/example/index.html",
                "query": "psychology example",
                "providers": {"pubmed": [{"pmid": "1"}], "crossref": [{"doi": "10/x"}]},
                "official_targets": ["site:who.int psychology example"],
            }],
        }
        plan = planner.build(report)
        self.assertEqual(plan["items"][0]["gate"], "evidence-candidates-ready-for-verification")
        self.assertEqual(plan["items"][0]["research"]["candidate_count"], 2)
