...
class WorkspaceDiscoveryWave10Test(unittest.TestCase):
    ...
    def test_global_gateway_keeps_28_and_workspace_links(self):
        ...
        for route in (
            ...
            self.assertIn(route,self.global_html)
    ...
    def test_workspace_wires_runtime_components(self):
        for route in (
            ...
            '/assessments/global-measures/print-packets/',
            '/assessments/global-measures/measurement-record/',
            '/sectors/rehabilitation/measures/#rights-sheet',
    ...
    def test_sitemap_discovers_workspace_pages_once(self):
        ...
        for url in (
            'https://healthrenewal.org/assessments/global-measures/workspace/',
            'https://healthrenewal.org/assessments/global-measures/tool-finder/',
            'https://healthrenewal.org/assessments/global-measures/print-packets/',
            'https://healthrenewal.org/assessments/global-measures/measurement-record/',
        ):
