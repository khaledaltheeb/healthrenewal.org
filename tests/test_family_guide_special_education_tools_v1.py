...
class ToolPublishingTests(unittest.TestCase):
    ...
    def test_parent_page_links_hub_and_uses_correct_arabic_agreement(self):
        ...
        self.assertIn("64 دليل حالة و15 أداة عملية", root)
        self.assertIn("64 دليل حالة و15 أداة أسرية", root)
        self.assertIn("64 دليل حالة و15 أداة مترابطة", root)
        self.assertIn("64 دليل حالة و15 أداة منشورة", root)
