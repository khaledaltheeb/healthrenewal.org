...
class PlatformIdentityV201Tests(unittest.TestCase):
    ...
    def test_replaces_labels_adds_shell_and_publishes_magazine(self) -> None:
        ...
        self.assertIn('"numberOfItems":80', index)
        self.assertEqual(index.count('class="card"'), 80)
        ...
        self.assertEqual(report["pages"], 86)
        ...
        self.assertEqual(report["magazine_pages"], 80)
        ...
        self.assertEqual(magazine["research_summaries_published"], 80)
        self.assertEqual(magazine["target_research_summaries"], 100)
        self.assertEqual(magazine["remaining_to_target"], 20)
        self.assertEqual(magazine["unwired_research_pages"], 0)
        self.assertEqual(magazine["sitemap"]["child_urls"], 81)
    ...
    def test_is_idempotent(self) -> None:
        ...
        self.assertEqual(magazine_report["research_summaries_published"], 80)
        self.assertEqual(magazine_report["target_research_summaries"], 100)
        self.assertEqual(magazine_report["sitemap"]["child_urls"], 81)
