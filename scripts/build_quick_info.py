...
def api():
    payload={"version":"1.0.0","generatedAt":PUBLISHED+"T09:00:00+03:00","count":len(TOPICS),"items":[{"slug":t["slug"],"title":t["title"],"format":t["format"],"domain":t["domain"],"summary":summary(t),"url":url(t),"image":img_url(t),"imageAlt":image_alt(t)} for t in TOPICS]}
