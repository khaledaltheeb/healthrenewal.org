...
<body class="rg-page"><a class="rg-skip" href="#main">تجاوز إلى المحتوى</a><header class="rg-header"><div class="rg-wrap rg-header-inner"><a class="rg-brand" href="{BASE_PATH}">منصة الصحة النفسية وذوي الاحتياجات الخاصة</a><nav class="rg-nav" aria-label="التنقل"><a href="../">المسارات</a><a href="../review-governance/">المراجعة العلمية</a><a aria-current="page" href="./">تدقيق الجودة</a></nav></div></header>
