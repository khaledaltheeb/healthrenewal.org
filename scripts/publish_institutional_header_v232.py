...
def render_header() -> str:
  ...
  <div class="wrap header-shell">
    ...
    <nav class="institutional-nav" aria-label="التنقل الرئيسي">
      ...
      <details class="header-menu language-menu" data-i18n-switcher-v72><summary><span class="language-summary"><small>اللغة</small><strong>العربية</strong></span><span class="menu-caret" aria-hidden="true">⌄</span></summary><div class="header-menu-panel language-panel"><p class="menu-heading">اختر لغة الواجهة</p><ul class="language-list">{render_language_links()}</ul></div></details>
    </nav>
  </div>
</header>'''
...
def validate(text: str) -> dict[str, object]:
    ...
    return {"version": VERSION, "status": "passed", "section_links": 12, "language_links": 3, "dropdowns": 2, "responsive": True, "keyboard_native_details": True, "reduced_motion_supported": True, "i18n_switcher_compatible": True}
