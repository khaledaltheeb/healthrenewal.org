...
def schema(tool: dict, source_map: dict) -> str:
    ...
    payload = {
      ...
      "@graph":[
        {"@type":"Article","@id":ORIGIN+route+"#article","headline":tool["title"],"description":tool["description"],"url":ORIGIN+route,"inLanguage":"ar","datePublished":"2026-08-02","dateModified":"2026-08-02","isAccessibleForFree":True,"citation":citations,"author":{"@type":"Organization","name":"منصة روافد"},"publisher":{"@type":"Organization","name":"منصة روافد"}},
...
<meta property="og:type" content="article"><meta property="og:locale" content="ar_AR"><meta property="og:site_name" content="منصة روافد"><meta property="og:title" content="{esc(tool['title'])}"><meta property="og:description" content="{esc(tool['summary'])}"><meta property="og:url" content="{ORIGIN}{route}"><meta property="og:image" content="{ORIGIN}/assets/brand/rawafid-social-card.jpg">
<meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="{esc(tool['title'])}"><meta name="twitter:description" content="{esc(tool['summary'])}"><meta name="twitter:image" content="{ORIGIN}/assets/brand/rawafid-social-card.jpg">
...
<header class="site-header"><div class="wrap head"><a class="brand" href="../../../">منصة روافد</a><nav class="nav"><a href="../../">دليل الأسرة</a><a href="../">مركز الأدوات</a><a href="../../../special-needs/">مركز الاحتياجات الخاصة</a><a href="../../../trust/">المنهجية</a></nav></div></header>
...
</main><footer class="footer"><div class="wrap">© منصة روافد · محتوى تثقيفي لا يستبدل التقييم الفردي.</div></footer></body></html>'''
