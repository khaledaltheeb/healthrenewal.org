...
<header><div class="ir-wrap ir-head"><a class="ir-brand" href="{BASE_PATH}">منصة روافد</a><nav class="ir-nav" aria-label="التنقل"><a href="../">المسارات المئة</a><a href="../methodology/">المنهجية</a><a aria-current="page" href="./">سجل الأدوات</a><a href="../evidence-standard/">معيار الأدلة</a><a href="../ten-plan-methodology/">الخطط العشر</a></nav></div></header>
