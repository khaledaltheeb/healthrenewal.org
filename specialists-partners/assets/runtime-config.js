...
(() => {
  ...
  const scripts = [
    ['../admin/admin-recovery-v10-final.js?v=10.2.0','ptAdminRecoveryV10'],
    ['../admin/admin-provider-status-v10.js?v=10.2.0','ptAdminProviderStatusV10']
  ];
